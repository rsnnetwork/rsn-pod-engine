...
const updateUserSchema = z.object({
  ...
  professionalRole: z.array(z.string().max(50)).max(10).optional(),
  ...
  meetingPreferences: z.array(z.string().max(100)).max(10).optional(),
  matchingNotes: z.string().max(1000).nullable().optional(),
