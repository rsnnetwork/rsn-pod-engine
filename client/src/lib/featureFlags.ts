...
// BG_NOFLASH_TRANSFORMER — Bug④ (2026-06-08; extended to all paths 2026-06-09).
...
// no longer briefly flashes the user's real room. Now runs on EVERY supported
// path — modern (desktop Chrome/Edge) AND the canvas fallback (iOS Safari /
// older Android), where that flash was most visible. Flip to false to instantly
